...
def process_image(p_image, settings: Settings):
    ...
    * Output visual display of the lane boundaries and numerical estimation of lane curvature and vehicle position.
    ...
    img_bird_eye, M = bird_eye_transform(img_adv, settings.aoi_src, settings.bird_dst)
...
settings_vid1.aoi_ymid = 0.615
settings_vid1.aoi_upsz = 0.051
settings_vid1.aoi_upds = 15
settings_vid1.aoi_basesz = 0.367
